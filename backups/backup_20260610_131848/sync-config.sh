...
git fetch --tags --force   # 'latest' is a moving tag; allow it to be updated
...
# 4️⃣ Commit and push
# ---------------------------
gum log --level info "Staging changes..."
git add .

gum log --level info "Committing..."
git commit -m "$COMMIT_MSG"

gum log --level info "Tagging $NEW_TAG..."
git tag "$NEW_TAG"

gum log --level info "Pushing to origin/main..."
